    ...
    >
      <header>
        ...
        <div class="header-actions">
          <button data-testid="export-help" type="button" aria-label="导出帮助" :disabled="busy" @click="emit('help')">?</button>
          <button type="button" aria-label="关闭导出" :disabled="busy" @click="emit('close')">×</button>
        </div>
      </header>
